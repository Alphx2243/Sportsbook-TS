...
function App() {
  ...
  const searchAvailability = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    const sampleSlots: Slot[] = Array.from({ length: 6 }, (_, i) => ({
      id: i + 1,
      courtName: `${sport as string} Court #${i + 1}`,
      slotTime: `${timeFrom as string} to ${timeTo as string}`,
